  ...
  return (
    <article className="catalog-row">
      ...
      <dl className="catalog-facts">
        <div><dt>Funding control</dt><dd>{card.custody}</dd></div>
        <div><dt>Network</dt><dd>{card.network}</dd></div>
        <div><dt>Maximum reported reward</dt><dd>{maximumReward(card)}</dd></div>
        <div><dt>Reported region</dt><dd>{card.regions}</dd></div>
      </dl>
